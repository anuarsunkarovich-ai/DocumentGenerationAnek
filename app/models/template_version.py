...
class TemplateVersion(Base, UUIDPrimaryKeyMixin, TimestampMixin):
    ...
    render_strategy: Mapped[str] = mapped_column(String(32), default="constructor", nullable=False)
    import_analysis: Mapped[dict] = mapped_column(JSONB, default=dict, nullable=False)
    import_bindings: Mapped[list[dict]] = mapped_column(JSONB, default=list, nullable=False)
